...
export default async function OrdersPage({ searchParams }: SearchParamProps) {
    ...
    return (
        <>
            <section className=" bg-primary-50 bg-dotted-pattern bg-cover bg-center py-5 md:py-10 px-4">
                <h3 className="wrapper h3-bold text-center sm:text-left ">
                    Orders
                </h3>
            </section>

            <section className="wrapper mt-8 px-4">
                <Search placeholder="Search buyer name..." />
            </section>

            <section className="wrapper overflow-x-auto px-4">
