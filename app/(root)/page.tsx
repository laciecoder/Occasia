...
export default async function Home({ searchParams }: SearchParamProps) {
    ...
    return (
        <>
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 2xl:gap-0">
                    <div className="flex flex-col justify-center gap-8 m-10 p-4">
                        <h1 className="text-xl font-bold md:text-4xl">
                            Organize. Offer. Outshine! Your Events, Our
                            Platform! Elevate with Occasia...
                        </h1>
                        <p className="font-light sm:text-sm md:text-lg">
                            Occasia simplifies event management, from planning
                            to ticketing, ensuring seamless, successful, and
            ...
            <section
                id="events"
                className="flex flex-col my-8 gap-8 md:gap-12 p-14"
            >
